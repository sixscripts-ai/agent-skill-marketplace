      ...
      <div className="space-y-6">
        <Panel className="p-6">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <h1 className="text-3xl font-semibold text-white">Install {skill.name}</h1>
          ...
          {skill.installTargets.map((target) => (
            <Panel key={target.platform} className="p-5">
              <div className="flex items-center justify-between gap-3">
                <h2 className="font-semibold text-white">{target.platform}</h2>
                <Badge>{target.packageFormat}</Badge>
              </div>
              <p className="mt-3 text-sm leading-6 text-slate-400">{target.notes}</p>
              <h3 className="mt-5 text-sm font-semibold text-white">Install command</h3>
              <div className="mt-2">
                <CodeBlock code={target.installCommand} />
              </div>
              <h3 className="mt-5 text-sm font-semibold text-white">Config snippet</h3>
              <div className="mt-2">
        ...
        <Panel className="p-5">
          <h2 className="font-semibold text-white">Package manifest</h2>
          <div className="mt-3">
            <CodeBlock
              code={JSON.stringify(
                {
