...
This brief was generated by ${skill.name} in the live browser sandbox using ${provider}. The virtual runner loaded ${fileList}, applied the permission policy, simulated allowlisted browser/network inspection, blocked shell execution by design, and preserved trace-backed metadata for replay and export.${replayNote} Treat this as a product strategy draft; validate current market claims against primary vendor docs before publication.
`;
}
