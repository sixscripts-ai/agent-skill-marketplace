...
export function ForkSkillButton({ slug }: { slug: string }) {
  ...
  return (
    <button
      ...
      className="h-10 rounded-md border border-[color-mix(in_srgb,var(--fire-heat)_40%,var(--border))] bg-[var(--fire-heat)] px-4 text-sm font-semibold text-white transition hover:bg-[var(--fire-heat-hover)] focus-visible:border-brand focus-visible:ring-3 focus-visible:ring-brand/50 disabled:cursor-wait disabled:opacity-60"
    >
