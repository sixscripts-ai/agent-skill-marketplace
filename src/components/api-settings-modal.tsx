...
export type ApiKeys = { openai?: string; anthropic?: string; google?: string; xai?: string };

export function ApiSettingsModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  const [keys, setKeys] = useState<ApiKeys>({ openai: "", anthropic: "", google: "", xai: "" });
  ...
  useEffect(() => {
    ...
    try {
      ...
      setKeys({ openai: "", anthropic: "", google: "", xai: "" });
    }
  }, [isOpen]);
