  ...
  return (
    <Panel className="p-4">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-5">
        {steps.map((step) => (
          <div key={`${step.label}-${step.title}`} className="rounded-md border border-[var(--fb-border-faint,var(--border))] bg-[var(--fb-panel,var(--card))] p-3 shadow-[0_2px_8px_rgba(38,38,38,0.04)]">
      ...
      <details>
        ...
        <div className="border-t border-neutral-200 p-5">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            {items.map((item) => (
              <div key={item.title} className="rounded-md border border-[var(--fb-border-faint,var(--border))] bg-[var(--fb-panel,var(--card))] p-4 shadow-[0_2px_8px_rgba(38,38,38,0.04)]">
